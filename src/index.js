...
// 读取landing.html文件 - 直接返回现代化版本的HTML内容
async function getLandingHtml() {
  // 直接返回现代化版本的landing.html内容
  // 这样就不需要依赖外部文件，直接在Worker中提供完整的页面
  return `<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>RuAlive - 智能追踪与通知平台</title>
...
<body>
    ...
    <div class="container">
        ...
        <section class="hero">
            ...
            <h1 class="hero-title">智能追踪，<br>让工作更高效</h1>
            <p class="hero-subtitle">RuAlive 是一款强大的智能追踪与通知平台，为企业级项目管理提供实时监控、数据分析和智能提醒服务</p>

            <div class="cta-group">
                <button class="btn btn-primary" onclick="handleLogin(this, '/login')">
                    <i class="fas fa-user"></i>
                    用户登录
                </button>
                <button class="btn btn-secondary" onclick="handleLogin(this, '/admin/login')">
                    <i class="fas fa-shield-alt"></i>
                    管理员登录
                </button>
                <button class="btn btn-glow" onclick="handleDemo(this)">
        ...
        <section class="features-section" id="features">
            ...
            <div class="features-grid">
                <div class="feature-card">
                    ...
                    <h3 class="feature-title">实时追踪</h3>
                    <p class="feature-description">毫秒级响应速度，实时监控项目进度和状态变化，确保您第一时间获取重要更新</p>
                </div>
                ...
                <div class="feature-card">
                    ...
                    <h3 class="feature-title">智能邮件</h3>
                    <p class="feature-description">AI驱动的邮件通知系统，支持自定义规则和模板，让重要信息精准触达</p>
                </div>
                ...
                <div class="feature-card">
                    ...
                    <p class="feature-description">强大的数据可视化工具，多维度分析项目趋势，为决策提供数据支撑</p>
                </div>
                ...
                <div class="feature-card">
                    ...
                    <p class="feature-description">企业级安全防护，端到端加密传输，严格的权限管理，保障数据安全</p>
                </div>
                ...
                <div class="feature-card">
                    ...
                    <h3 class="feature-title">API集成</h3>
                    <p class="feature-description">丰富的API接口，支持与主流工具无缝集成，打造专属工作流程</p>
                </div>
                ...
                <div class="feature-card">
                    ...
                    <p class="feature-description">响应式设计，完美适配各种设备，随时随地掌握项目动态</p>
                </div>
            </div>
        </section>
        ...
        <section class="testimonials-section" id="testimonials">
            ...
            <div class="testimonial-card">
                <p class="testimonial-text">"RuAlive彻底改变了我们团队的项目管理方式。实时追踪功能让我们能够快速响应变化，邮件通知系统大大提高了工作效率。"</p>
            ...
            <div class="testimonial-card">
                <p class="testimonial-text">"数据分析功能非常强大，帮助我们发现了之前忽略的项目瓶颈。界面简洁美观，使用体验极佳。"</p>
                <div class="testimonial-author">
        ...
        <footer id="contact">
            <div class="footer-content">
                <div class="footer-links">
                    ...
                    <a href="#"><i class="fab fa-weixin"></i> 微信公众号</a>
                    <a href="#"><i class="fas fa-envelope"></i> 联系我们</a>
                </div>
                <p class="footer-text">
                    © 2026 RuAlive. 保留所有权利。<br>
                    智能追踪与通知平台 | 让项目管理更高效<br>
                    京ICP备2026000001号
                </p>
            </div>
        </footer>
    ...
    <script>
        ...
        // Button click handlers - PRESERVED ORIGINAL FUNCTIONALITY
        function handleLogin(button, path) {
            button.classList.add('btn-loading');
            button.innerHTML = '<i class="fas fa-spinner"></i> 正在跳转...';

            // Simulate loading and then redirect (preserving original behavior)
            setTimeout(() => {
                console.log('Redirecting to:', path);
                // Actual redirect - preserving original functionality
                window.location.href = path;

                // Fallback UI update in case redirect doesn't happen immediately
                setTimeout(() => {
                    button.classList.remove('btn-loading');
                    button.innerHTML = '<i class="fas fa-check"></i> 跳转完成';

                    setTimeout(() => {
                        const originalContent = button.innerHTML.includes('用户登录') ?
        ...
        function handleDemo(button) {
            button.classList.add('btn-loading');
            button.innerHTML = '<i class="fas fa-spinner"></i> 正在加载演示...';

            setTimeout(() => {
                alert('演示功能即将开放，敬请期待！');
                button.classList.remove('btn-loading');
                button.innerHTML = '<i class="fas fa-play"></i> 在线演示';
            }, 2000);
        }
...
export default {
  async fetch(request, env) {
    ...
    if (path === '/' || path === '/index.html') {
      // 直接返回现代化版本的landing页面
      try {
        const landingHtml = await getLandingHtml();
...
<head>
  <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <title>错误 - RuAlive</title>
</head>
<body>
  <h1>页面加载失败</h1>
  <p>无法加载landing页面: ${error.message}</p>
</body>
</html>`, {
          headers: { 'Content-Type': 'text/html;charset=UTF-8' }
        });
